  ...
  return (
    <div className="testimonials">
      ...
      >
        ...
        <SwiperSlide>
          <TestCard name='Ardra V V' position={'Upcoming'} image={ardra_v_v} text="Joining EETI Foundation transformed my professional journey—more than program management, it was a personal metamorphosis. Grateful for the enriching experience, I broadened my network, interacted with speakers, and acquired skills that are invaluable assets for my future" />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name='Saniya Teresa Sandeep' position={'Upcoming'} image={saniya} text="It was a delight for me to be a part of the EETIF program team. Whether it be contacting the speakers, designing the posters or anchoring the session, all of those helped me improve myself in all ways possible." />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name='Akshay P K ' position={'Upcoming'} image={akshay_p_k} text="In my third year of Electronics and Communication Engg at CET, I decided to join EETIF based on my interest in being a part of a club that not only provides free technical classes but also actively contributes to the community. I was drawn to the idea of expanding my network and enhancing my technical skills in a collaborative environment. Joining EETIF as a programming team member has proven to be a rewarding experience, allowing me to connect with like-minded individuals , help organise lectures workshops and contribute to the community while gaining valuable insights. Glad to be part of EETIF.				" />
        </SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
          <TestCard name='Neeraj Rajeev' position={'Upcoming'} image={neeraj_rajeev} text="My experience as a program team member at EETI Foundation was incredibly enriching. It provided me with invaluable opportunities to develop my skills in event organization and online session management. I learned the importance of collaboration, time management, and adaptability in delivering engaging and impactful programs. The supportive environment at EETI fostered my personal and professional growth, allowing me to contribute significantly to the foundation's mission. I am grateful for my time at EETIF and look forward to applying the knowledge and experience gained to future endeavors." />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name='Hilan S Shiva' position={'Upcoming'} image={hilan} text="Working at the EETI Foundation provided an excellent opportunity to meet new people while also exposing me to like-minded individuals. I believe I performed well considering it was my first time working in a team. I sincerely appreciate the EETI foundation giving me this chance.	" />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name='Aswathy K' position={'Upcoming'} image={aswathy} text="Working alongside an amazing panel of teammates, I gained valuable insights into the essence of effective group collaboration. The dynamic nature of our tasks not only made every day eventful but also enhanced my team management skills significantly. This hands-on experience is truly worth boasting about, as it enriched my professional journey in ways I hadn't imagined."	 />
        </SwiperSlide>
        <SwiperSlide>
