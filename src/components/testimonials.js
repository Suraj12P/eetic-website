...
const Testimonials = () => {
  ...
  return (
    <div className="testimonials">
      ...
      >
        <SwiperSlide>
          <TestCard name="Nandana J" position={'Upcoming Graduate Engineering Trainee, L&T'} image={nandana} text="During my tenure as the Content Head at EETI Foundation, I gained valuable insights into organizational workflows, project management, and content creation. This role allowed me to delve deeply into various projects, significantly enhancing my content writing skills. Collaborating within a dedicated team, I witnessed firsthand the impact of effective content strategies on engagement and outreach. Moreover, working in this organization provided me with a platform to expand my network within the college community, fostering stronger connections. The diverse activities conducted by EETI Foundation offered me exposure to a wide range of experiences, contributing to my holistic growth and development. Overall, my experience at EETI Foundation was invaluable, offering practical knowledge in content creation, leadership, teamwork dynamics, and expanded connections within the college." />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name="Sreekiran" position={'Upcoming Post- Graduate Engineer Trainee, JSW Steels'} image={sreekiran} text="I am thrilled to share that I've secured a placement at JSW Steels through campus recruitment. This achievement is a testament to the exceptional education and preparation I received. I extend special thanks to the technical community 'EETI Foundation' for their invaluable support and knowledge throughout my placement journey. The collaborative spirit and abundant resources provided by EETI Foundation significantly contributed to my growth and industry readiness. I look forward to applying the skills gained here to make a meaningful contribution to the industry. Thank you for providing me with an enriching academic experience and fostering an environment that cultivates excellence." />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name="Jaidan Sleeba" position={'Upcoming SDE-1, CareStack'} image={jaidan} text="I served as the webmaster of EETI Foundation for 6 months. I led the development of EETI Foundation's website and also had the opportunity to mentor interns during that time. I had an amazing time working with innovative minds. This experience allowed me to apply my technical skills to a meaningful cause and contributed to both my personal and professional growth" />
        </SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
          <TestCard name='Saranya V S' position={'Upcoming ASE at Accenture'} image={saranya_v_s} text="Being in the Program Team of EETIC, we have planned and organized several events. It was a wonderful experience for me." />
        </SwiperSlide>
        <SwiperSlide>
