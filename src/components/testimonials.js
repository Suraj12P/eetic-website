  ...
  return (
    <div className="testimonials">
      ...
      >
        ...
        <SwiperSlide>
          <TestCard name='Muhammed Shehin' position={''} image={shehin} text ="Hello everyone, I'm Shehin, a student pursuing BTech at CET. Alongside my studies, I've ventured into freelance poster design. My journey began with creating posters for EETI Foundation, an organization that played a significant role in my growth as a graphic designer. I'm content with my current position and grateful to EETI Foundation for being a crucial part of my development." />
        </SwiperSlide>
        <SwiperSlide>
          <TestCard name='Suryagayathri Thangalazhi' position={''} image={surya} text="Working as a Jr Chief Executive Officer at EETI Foundation was an incredibly rewarding experience for me. As a non-profit organization dedicated to boosting the technical and non technical skills in students, the Foundation's mission was one that resonated deeply with me. My role was multifaceted, and I had the opportunity to work closely with a team of passionate individuals who were committed to making a positive impact in the world. I was able to hone my leadership and communication skills. Overall, my time at EETI Foundation was a valuable and fulfilling experience that has shaped my career aspirations and left a lasting impression on me." />
        </SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
          <TestCard name='Saniya Teresa Sandeep' position={''} image={saniya} text="It was a delight for me to be a part of the EETI program team. Whether it be contacting the speakers, designing the posters or anchoring the session, all of those helped me improve myself in all ways possible." />
        </SwiperSlide>
        <SwiperSlide>
